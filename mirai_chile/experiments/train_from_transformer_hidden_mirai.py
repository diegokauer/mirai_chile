...
from mirai_chile.configs.mirai_base_config import TrainFromTransformerHidden
...
def main(args):
    ...
    args = TrainFromTransformerHidden()
    ...
    eval_pipe.add_metric(CIndex(), {"censoring_dist": dataset.censoring_dist})
