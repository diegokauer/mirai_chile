...
from mirai_chile.configs.train_config import TrainTransformerCPFHiddenConfig
...
from mirai_chile.models.loss.mirai_loss import MiraiLoss
...
def main(args):
    ...
    args = TrainTransformerCPFHiddenConfig()
    loss_function = MiraiLoss(args)
