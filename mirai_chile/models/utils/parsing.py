...
def parse_args():
    ...
    parser.add_argument('--train_years', nargs='*', type=int, default=[2016, 2015, 2014, 2013, 2012, 2011, 2010, 2009],
                        help='The list of years to draw training data for mammo risk datasets.')
    parser.add_argument('--dev_years', nargs='*', type=int, default=[2016, 2015, 2014, 2013, 2012, 2011, 2010, 2009],
                        help='The list of years to draw dev data for mammo risk datasets.')
    parser.add_argument('--test_years', nargs='*', type=int, default=[2016, 2015, 2014, 2013, 2012, 2011, 2010, 2009],
    ...
    parser.add_argument('--shift_class_bal_towards_imediate_cancers', action='store_true', default=False,
                        help='Wether to apply a weighted sampler to balance between the classes on each batch.')
    ...
    parser.add_argument('--location_network_block_layout', type=str, nargs='+',
    ...
    parser.add_argument('--region_annotation_contrast_alpha', type=float, default=.3,
    ...
    parser.add_argument('--temporal_mmd_discount_factor', type=float, default=.60,
    ...
    parser.add_argument('--risk_factor_metadata_path', type=str,
    ...
    parser.add_argument('--use_precomputed_hiddens_in_get_hiddens', action='store_true', default=False,
                        help='Whether to only use hiddens from a pretrained model.')
    parser.add_argument('--hiddens_results_path', type=str,
    ...
    # resnet-specific
    parser.add_argument('--block_layout', type=str, nargs='+',
                        default=["BasicBlock,2", "BasicBlock,2", "BasicBlock,2", "BasicBlock,2"],
                        help='Layout of blocks for a ResNet model. Must be a list of length 4. Each of the 4 elements is a string of form "block_name,num_repeats-block_name,num_repeats-...". [default: resnet18 layout]')
